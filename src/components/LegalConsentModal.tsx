  ...
  return <>
    <div className="fixed inset-0 z-[70] bg-black/70 backdrop-blur-sm p-4 flex items-center justify-center">
      <div className="w-full max-w-lg rounded-3xl bg-white dark:bg-[#182232] border border-[#bdcabe]/40 dark:border-[#2d3e58] shadow-2xl p-6 space-y-5">
        ...
        <div><h2 className="text-xl font-bold">Review MarketPulse account terms</h2><p className="text-sm text-[#6e7a70] mt-2">Before continuing with this account, acknowledge the current Terms of Use and Privacy Notice. This does not change your role or permissions.</p></div>
